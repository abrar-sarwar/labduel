...
export const BLUE_UPGRADES: Upgrade[] = [
  ...
  },
  {
    ...
    name: "Honeypot",
    cost: 4,
    blurb: "+8% to your squad's points next round.",
    concept: "Deception catches intruders who think they're unseen.",
    effect: { kind: "scoreNextRound", pct: 0.08 },
  },
  {
    id: "backups",
    team: "blue",
  ...
  },
  {
    ...
    name: "IR Playbook",
    cost: 4,
    blurb: "Reduce company damage by 15 now.",
    concept: "A rehearsed response shrinks the blast radius.",
    effect: { kind: "reduceDamage", amount: 15 },
  },
  {
    id: "watchtower",
    team: "blue",
  ...
  },
  {
    ...
    cost: 2,
    blurb: "+7 now, but premiums cut future income by 2.",
    concept: "Insurance funds recovery, it doesn't erase the incident.",
    effect: { kind: "insurance", money: 7, premium: 2 },
  },
];
...
export const RED_UPGRADES: Upgrade[] = [
  ...
  },
  {
    id: "intel",
    team: "red",
    name: "Intel on Defenses",
    cost: 4,
    blurb: "+8% to your squad's points next round.",
    concept: "Knowing the defenses tells you where to push.",
    effect: { kind: "scoreNextRound", pct: 0.08 },
  },
  {
    id: "siegeengine",
  ...
  },
  {
    ...
    name: "War Chest",
    cost: 2,
    blurb: "+7 now, but funders take 2 from future income.",
